...
class Item:
    ...
    def __init__(self, id: str, created: datetime, modified: datetime, responsible_department: str, backside_protection: bool, acquisition_date: datetime, acquisition_date_precision: datetime, dimensions: List[Dimension], documentation: List[Documentation], exhibitions: List[Exhibition], inscriptions: List[Inscription], materials: List[str], object_names: List[ObjectName], production: List[Production], production_date: List[ProductionDate], techniques: List[str], titles: List[Title], medium: List[str], object_history_note: List[str], number_of_parts: int, object_number: str, object_url: str, frontend_url: str, iiif_manifest: str, enrichment_url: str, similar_images_url: str, production_dates_notes: List[str], public_domain: bool, rights: str, on_display: bool, has_image: bool, image_width: int, image_height: int, image_thumbnail: str, image_native: str, colors: List[str], suggested_bg_color: List[str], entropy: float, contrast: float, saturation: float, colortemp: float, brightness: float, has_text: bool, has_3_d_file: bool, artist: List[str]) -> None:
        self.id = id
    ...
    def from_dict(obj: Any) -> 'Item':
        ...
        return Item(id, created, modified, responsible_department, backside_protection, acquisition_date, acquisition_date_precision, dimensions, documentation, exhibitions, inscriptions, materials, object_names, production, production_date, techniques, titles, medium, object_history_note, number_of_parts, object_number, object_url, frontend_url, iiif_manifest, enrichment_url, similar_images_url, production_dates_notes, public_domain, rights, on_display, has_image, image_width, image_height, image_thumbnail, image_native, colors, suggested_bg_color, entropy, contrast, saturation, colortemp, brightness, has_text, has_3_d_file, artist)
